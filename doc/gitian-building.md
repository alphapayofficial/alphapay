...
*Setup instructions for a Gitian build of Alphapay Core using a Debian VM or physical system.*
...
- [Building Alphapay Core](#building-bitcoin-core)
...
To build Alphapay Core (for Linux, OS X and Windows) just follow the steps under 'perform
...
APYPATH=/some/root/path/bitcoin
SIGPATH=/some/root/path/bitcoin-detached-sigs

./bin/gbuild --url bitcoin=${APYPATH},signature=${SIGPATH} ../bitcoin/contrib/gitian-descriptors/gitian-win-signer.yml
```
