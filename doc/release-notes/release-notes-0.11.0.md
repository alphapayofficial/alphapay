Alphapay Core version 0.11.0 is now available from:
...
defaults to 0.00001. This will cause transactions with fewer APY/kB fee to be
...
Block pruning allows Alphapay Core to delete the raw block and undo data once 
...
block index and UTXO databases. The minimum was chosen so that Alphapay Core will 
...
- #6116 `30dc3c1` [OSX] rename Alphapay-Qt.app to Bitcoin-Core.app
