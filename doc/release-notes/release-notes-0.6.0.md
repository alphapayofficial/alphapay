...
Alphapay-Qt can display and save QR codes for sending
...
versions of Alphapay-Qt/bitcoind.
...
Alphapay-Qt's initial splash screen
...
opening/launching Alphapay-Qt is available only on Linux,
and only if you configure your desktop to launch
Alphapay-Qt. All platforms support dragging and dropping
bitcoin: URIs onto the Alphapay-Qt window to start
payment.
...
It is expected that future releases of Alphapay-Qt
