Alphapay Core version 0.13.1 is now available from:
...
- **Increased security for multisig:** Alphapay addresses (both P2PKH addresses
...
- **More efficient almost-full-node security** Satoshi Nakamoto's original
  ...
  note that Alphapay Core does not provide an option to use this capability as
  of this 0.13.1 release.

- **Script versioning:** Segwit makes it easy for future soft forks to allow
  Bitcoin users to individually opt-in to almost any change in the Bitcoin
  Script language when those users receive new transactions.  Features
  currently being researched by Alphapay Core contributors that may use this
...
Since Alphapay Core 0.10.0, nodes have defaulted to only relaying and
