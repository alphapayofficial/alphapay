Alphapay Core version 0.9.0 is now available from:
...
over /Applications/Alphapay-Qt (on Mac) or bitcoind/bitcoin-qt (on Linux).
...
Rebranding to Alphapay Core
---------------------------

To reduce confusion between Bitcoin-the-network and Bitcoin-the-software we
have renamed the reference client to Alphapay Core.
...
Using the standard "./autogen.sh; ./configure; make" to build Alphapay-Qt and
...
0.1mAPY per kilobyte. During periods of heavy transaction volume, even this
...
- Drop the fee required to relay a transaction to 0.01mAPY per kilobyte
