...
Source22:	https://raw.githubusercontent.com/bitcoin/bitcoin/v%{version}/doc/man/alphapay-qt.1
...
%if %{_buildqt}
install -p %{SOURCE22} %{buildroot}%{_mandir}/man1/alphapay-qt.1
%endif
...
%attr(0755,root,root) %{_bindir}/alphapay-qt
...
%attr(0644,root,root) %{_mandir}/man1/alphapay-qt.1*
%endif
